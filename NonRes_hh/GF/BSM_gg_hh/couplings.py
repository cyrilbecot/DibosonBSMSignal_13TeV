...
GC_36 = Coupling(name = 'GC_36',
                 value = '-c2*(aS*complex(0,1))/(3.*cmath.pi*vev**2)*(-3./2.)',
                 order = {'QCD':2,'QED':2})

# Added for additional BSM Operator HGG HHGG

GC_37 = Coupling(name = 'GC_37',
                 value = '(aS*complex(0,1))/(3.*cmath.pi*vev)*a1',
                 order = {'QCD':2,'QED':1})

GC_38 = Coupling(name = 'GC_38',
                 value = '-(aS*complex(0,1))/(3.*cmath.pi*vev**2)*a2',
                 order = {'QCD':2,'QED':2})
