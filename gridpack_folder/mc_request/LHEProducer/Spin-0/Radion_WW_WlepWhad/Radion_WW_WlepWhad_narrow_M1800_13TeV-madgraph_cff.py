...
# link to cards:
# https://github.com/cms-sw/genproductions/tree/master/bin/MadGraph5_aMCatNLO/cards/production/13TeV/exo_diboson/Spin-0/Radion_WW_WlepWhad/Radion_WW_WlepWhad_narrow_M1800
